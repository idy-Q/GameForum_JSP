    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="d-flex align-items-center mb-4 pb-2 border-bottom border-secondary">
                <h3 class="text-white mb-0"><i class="fas fa-chess text-success me-2"></i> 策略游戏</h3>
                <span class="ms-3 badge bg-dark border border-secondary text-muted">Strategy Games</span>
            </div>
            ...
            <div class="posts-list">
                ...
                <c:if test="${empty posts}">
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">暂无策略游戏帖子，快来发表第一个吧！</p>
        ...
        <div class="col-lg-4">
            ...
            <div class="card bg-dark border-secondary">
                <div class="card-body text-center">
                    <h6 class="text-white mb-2">分享你的策略战术</h6>
